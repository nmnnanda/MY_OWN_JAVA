...
public class E_While {
    public static void main(String[] args) {
        ...
        while (count <= num) {                         // Starting a while loop that will run as long as count is less than num
           System.out.println("Count is: " + count);  // Printing the current value of count
